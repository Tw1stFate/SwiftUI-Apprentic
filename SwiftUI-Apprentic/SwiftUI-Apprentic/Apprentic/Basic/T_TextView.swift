...
struct T_TextView: View {
    let manyString = "这是一段长文。似花还似非花，也无人惜从教坠。抛家傍路，思量却是，无情有思。萦损柔肠，困酣娇眼，欲开还闭。梦随风万里，寻郎去处，又还被莺呼起。不恨此花飞尽，恨西园，落红难缀。晓来雨过，遗踪何在？一池萍碎。春色三分，二分尘土，一分流水。细看来，不是杨花，点点是离人泪。"
        var body: some View {
            ScrollView {
                Group {
...
// Attribute
struct T_TextViewAttribute: View {
...
// MarkDownView
struct T_TextViewMarkdown: View {
...
//            mda = AttributedString(localized: "^[这是](p2:'one')^[一](p3:{k1:1,k2:2})个 **Attribute** ~string~", including: \.newScope)
            ...
            // 从文件中读取 Markdown 内容
            let mdUrl = Bundle.main.url(forResource: "README", withExtension: "md")!
...
// MARK: - 插值
struct T_TextViewInterpolation: View {
...
struct T_TextView_Previews: PreviewProvider {
